...
fn t26_aa_test() {
    ...
    for i in 1..=20 {
        ...
        let span =
            agg::SpanGradient::new(gradient_mtx, agg::GradientX {}, &gradient_colors, 0.0, 100.0);
        ...
        let gradient_colors =
            color_gradient(agg::Rgb8::new(255, 0, 0), agg::Rgb8::new(0, 0, 255), 256);
        let x1 = 17.5 + (k * 4.0);
        let y1 = 107.;
        ...
        let colors = color_gradient(agg::Rgb8::new(255, 0, 0), agg::Rgb8::new(255, 255, 255), 256);
        let x1 = 21.5;
        ...
        let colors = color_gradient(agg::Rgb8::new(0, 255, 0), agg::Rgb8::new(255, 255, 255), 256);
        let x1 = 52.5;
        let y1 = 118.0 + (k * 3.0);
        let x2 = 83.5;
        let y2 = 118.0 + (k * 3.0);
        ...
        let colors = color_gradient(agg::Rgb8::new(0, 0, 255), agg::Rgb8::new(255, 255, 255), 256);
        let x1 = 83.5;
        let y1 = 119.0 + (k * 3.0);
        let x2 = 114.5;
        let y2 = 119.0 + (k * 3.0);
